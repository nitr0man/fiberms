 ...
 * USA.
 *
 * $Id: mysql.2004031400.php,v 1.13 2011/01/18 08:12:08 alec Exp $
 */
...
$DB->Execute("ALTER TABLE admins DROP INDEX id");
$DB->Execute("ALTER TABLE admins DROP INDEX id_2");
$DB->Execute("ALTER TABLE admins ADD UNIQUE (login)");
$DB->Execute("ALTER TABLE assignments DROP INDEX id");
$DB->Execute("ALTER TABLE assignments DROP INDEX id_2");
$DB->Execute("ALTER TABLE cash DROP INDEX id");
$DB->Execute("ALTER TABLE cash DROP INDEX id_2");
$DB->Execute("ALTER TABLE cash CHANGE value value DECIMAL(9, 2) NOT NULL");
$DB->Execute("ALTER TABLE dbinfo DROP INDEX keytype");
$DB->Execute("ALTER TABLE dbinfo DROP INDEX keytype_2");
$DB->Execute("ALTER TABLE invoicecontents CHANGE pkwiu pkwiu VARCHAR(255) DEFAULT '' NOT NULL");
$DB->Execute("ALTER TABLE invoices DROP INDEX id");
$DB->Execute("ALTER TABLE invoices DROP INDEX id_2");
$DB->Execute("ALTER TABLE invoices CHANGE nip nip VARCHAR(16) NOT NULL, CHANGE pesel pesel VARCHAR(11) NOT NULL");
$DB->Execute("ALTER TABLE netdevices CHANGE name name VARCHAR(32) NOT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE producer producer VARCHAR(64) NOT NULL, CHANGE model model VARCHAR(32) NOT NULL, CHANGE serialnumber serialnumber VARCHAR(32) NOT NULL, CHANGE ports ports INT(10) NOT NULL");
$DB->Execute("ALTER TABLE netdevices DROP INDEX name");
$DB->Execute("ALTER TABLE netlinks ADD UNIQUE (src, dst)");
$DB->Execute("ALTER TABLE networks CHANGE gateway gateway VARCHAR(16) NOT NULL, CHANGE interface interface VARCHAR(8) NOT NULL, CHANGE dns dns VARCHAR(16) NOT NULL, CHANGE dns2 dns2 VARCHAR(16) NOT NULL, CHANGE wins wins VARCHAR(16) NOT NULL, CHANGE dhcpstart dhcpstart VARCHAR(16) NOT NULL, CHANGE dhcpend dhcpend VARCHAR(16) NOT NULL");
$DB->Execute("ALTER TABLE networks DROP INDEX id");
$DB->Execute("ALTER TABLE networks DROP INDEX id_2");
$DB->Execute("ALTER TABLE nodes DROP INDEX id");
$DB->Execute("ALTER TABLE nodes DROP INDEX id_2");
$DB->Execute("ALTER TABLE nodes CHANGE netdev netdev INT(11) DEFAULT '0' NOT NULL");
$DB->Execute("ALTER TABLE nodes ADD UNIQUE (name)");
$DB->Execute("ALTER TABLE nodes ADD UNIQUE (mac)");
$DB->Execute("ALTER TABLE nodes ADD UNIQUE (ipaddr)");
$DB->Execute("ALTER TABLE payments CHANGE description description TEXT NOT NULL");
$DB->Execute("ALTER TABLE payments DROP INDEX id");
$DB->Execute("ALTER TABLE payments DROP INDEX id_2");
$DB->Execute("ALTER TABLE rtqueues ADD UNIQUE (name)");
$DB->Execute("ALTER TABLE stats DROP PRIMARY KEY");
$DB->Execute("ALTER TABLE stats ADD UNIQUE (nodeid, dt)");
$DB->Execute("ALTER TABLE tariffs CHANGE value value DECIMAL(9, 2) NOT NULL, CHANGE taxvalue taxvalue DECIMAL(9, 2) NOT NULL, CHANGE pkwiu pkwiu VARCHAR(255) NOT NULL, CHANGE description description TEXT NOT NULL");
$DB->Execute("ALTER TABLE tariffs DROP INDEX id");
$DB->Execute("ALTER TABLE tariffs DROP INDEX id_2");
$DB->Execute("ALTER TABLE tariffs ADD UNIQUE (name)");
$DB->Execute("ALTER TABLE timestamps ADD UNIQUE (tablename)");
$DB->Execute("ALTER TABLE users CHANGE lastname lastname VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE status status INT(11) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE phone1 phone1 VARCHAR(255) NOT NULL, CHANGE phone2 phone2 VARCHAR(255) NOT NULL, CHANGE phone3 phone3 VARCHAR(255) NOT NULL, CHANGE gguin gguin INT(11) NOT NULL DEFAULT 0, CHANGE zip zip VARCHAR(6) NOT NULL, CHANGE city city VARCHAR(32) NOT NULL, CHANGE nip nip VARCHAR(16) NOT NULL, CHANGE pesel pesel VARCHAR(11) NOT NULL, CHANGE info info TEXT NOT NULL");
$DB->Execute("ALTER TABLE users DROP INDEX id");
