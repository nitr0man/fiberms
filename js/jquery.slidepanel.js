;( function( $, window, document, undefined ) {
    ...
    Slidepanel.prototype.init = function() {
        ...
        this.$panel.css( 'left', '' ).css( 'right', '' ).css( 'top', '' ).css(
                'bottom', '' );
    ...
    Slidepanel.prototype.load = function() {
        ...
        if ( this.$panel.data( 'slidepanel-current' ) == this.$element ) {
            ...
            if ( this.$panel.data( 'slidepanel-loaded' ) !== href ) {
                ...
                $( '.inner .wrapper', this.$panel ).html( '' ).load( href,
                        function() {
    ...
    Slidepanel.prototype.expand = function() {
        ...
        if ( this.options.mode == 'push' ) {
            ...
            this.$body.css( 'position', 'absolute' ).animate( body_options,
                    250 );
        }

        //animate the panel into view
        this.$panel.addClass( 'loading' ).animate( panel_options, 250,
                function() {
    ...
    Slidepanel.prototype.collapse = function() {
        ...
        if ( this.options.mode == 'push' ) {
            this.$body.css( 'position', this.$body_position ).animate(
                    body_options, 250 );
        }
        //animate the panel out of view
        this.$panel.animate( panel_options, 250 ).data( 'slidepanel-current',
                false );
    };
    ...
    $.fn['slidepanel'] = function( options ) {
        return this.each( function() {
            if ( !$.data( this, 'plugin_slidepanel' ) ) {
                $.data( this, 'plugin_slidepanel', new Slidepanel( this,
                        options ) );
            }
        } );
    }
