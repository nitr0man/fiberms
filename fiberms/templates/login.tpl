...
<tr><td></td></td><td align=center><label class="events_anonce">&nbsp;&nbsp;<input type="checkbox" name="remember" checked="true" style="width:auto;"> Запомнить</label><br /></td></tr>
...
<tr><td colspan=2>&nbsp;</td></tr>
 ...
 <label class="events_anonce"><input type="checkbox" name="remember" checked="true"> Запомнить</label>
